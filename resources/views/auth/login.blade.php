    ...
    <div class="container-xxl">
        <div class="authentication-wrapper authentication-basic container-p-y">
            <div class="authentication-inner">
                <!-- Register -->
                <div class="my-3">
                    <a href="{{ route('plan-operativo') }}" type="button" class="btn btn-outline-primary">Ver Plan Operativo
                        Anual</a>
                </div>
                <div class="my-3">
                    <a href="{{ route('plan-ejecucion') }}" type="button" class="btn btn-outline-primary">Ver ejecución</a>
                </div>
                <div class="card">
                    <div class="card-body">
                        <!-- Logo -->
                        <div class="app-brand justify-content-center">
                            <a class="app-brand-link gap-2">
                                <span class="app-brand-logo demo"><img src="{{ asset('/icono.jpg') }}"
